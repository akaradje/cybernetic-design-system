/** Dirty component — fails multiple CDS checks. */
export function DirtyPanel() {
  return (
    <div className="p-[13px] m-5 bg-white">
      <h2 className="text-slate-900 text-2xl mb-3">Account settings</h2>
      <p className="text-slate-400 bg-white mt-[7px]">
        Subtle helper text that is hard to read.
      </p>
      <div className="gap-[10px] mt-4 p-2">
